...
/*#ifdef DEFAULTS_SIMULATOR
  ...
  #define DEFAULT_X_STEPS_PER_MM 1066.6667 //default 80.0
  #define DEFAULT_Y_STEPS_PER_MM 1066.6667 //default 80.0
  #define DEFAULT_Z_STEPS_PER_MM 1066.6667 //default 80.0
  #define DEFAULT_X_MAX_RATE 1000.0 //2500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 1000.0 //2500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (10.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (10.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 600.0 //200.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 800.0 //200.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 140.0 //200.0 // mm
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
